...
import CropMethod from "./ProfileImageCorp/CropMethod";

// eslint-disable-next-line react/prop-types
const UserProfilePicture = ({ avatar }) => {
...
console.log("Image URL:", stables.UPLOAD_FOLDER_BASE_URL + avatar);
console.log("Image URL2:", `${stables.UPLOAD_FOLDER_BASE_URL}${avatar}`);

  return (
    <>
      {openCrop &&
        createPortal(
          <CropMethod photo={photo} setOpenCrop={setOpenCrop} />,
      ...
      <div className="w-full flex items-center gap-x-4">
        <div className="relative w-20 h-20 rounded-full outline outline-offset-2 outline-1 lutline-primary overflow-hidden">
          ...
          >
            {avatar ? (
              <img
               src={avatar ? `${stables.UPLOAD_FOLDER_BASE_URL}${avatar}` : undefined}
